...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference("Subcategory.count") do
      post subcategories_url, params: { subcategory: { string: @subcategory.string, text: @subcategory.text, title: @subcategory.title } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { string: @subcategory.string, text: @subcategory.text, title: @subcategory.title } }
